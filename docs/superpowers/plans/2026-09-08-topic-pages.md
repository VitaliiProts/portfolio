...
- Жодних цін числами в тексті тем: сторінка описує формат і тривалість, а суми показує блок `Pricing` нижче, який читає `prices` з `lib/site.ts`. Інакше шість сторінок безшумно розійдуться з блоком при першій же зміні ціни. Рішення користувача від 2026-09-08.
- Callout безпеки лишається одним списком з одним маршрутом (лікар / приймальне відділення / 103), без окремої лінії для суїцидальних думок. Рішення користувача від 2026-09-08; винесено на вичитку Крістель як професійне питання.
...
- `format` (120–150 слів): онлайн і очно в центрі Києва, 50–60 хвилин, наявність формату парної сесії з батьками, оплата за добу, перенесення за 24 години, конфіденційність і псевдонім. Сум не називати — за цінами відсилаємо до блоку нижче на сторінці.
